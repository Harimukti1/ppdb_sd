...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SDIT<span class="text-primary">.</span></a>
            </div>
            <div class="site-quick-contact d-none d-lg-flex ml-auto ">
              <div class="d-flex site-info align-items-center mr-5">
                <span class="block-icon mr-3"><span class="icon-map-marker text-yellow"></span></span>
                <span>Jl.sumbawa 7, Perumnas 3 Bekasi, <br> Kec. Bekasi Timur, Kota Bekasi  </span>
              </div>
              <div class="d-flex site-info align-items-center">
                <span class="block-icon mr-3"><span class="icon-clock-o"></span></span>
                <span>Senin - Jumat 08.00 - 16.00 <br> Sabtu & Minggu Tutup</span>
              </div>
        ...
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-5 mt-5 pt-5">
              ...
              <p>Sekolah Islam yang unggul dan handal dalam pelayanan pendidikan dan berorientasi ke masa depan yang gemilang.</p>
    ...
    <footer class="site-footer" style="padding: 20px 0 5px 0">
      <div class="container">
        <p class="text-center"> Developer : @mukti676 </p>
        <br><center><p>Repost by Sd It Baiturahman</p></center>
